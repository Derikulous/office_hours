...
class SolutionsControllerTest < ActionController::TestCase
  ...
  test "should create solution" do
    assert_difference('Solution.count') do
      post :create, solution: { correct: @solution.correct, question_id: @solution.question_id, user_id: @solution.user_id }
    end
  ...
  test "should update solution" do
    patch :update, id: @solution, solution: { correct: @solution.correct, question_id: @solution.question_id, user_id: @solution.user_id }
    assert_redirected_to solution_path(assigns(:solution))
  end
